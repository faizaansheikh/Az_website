...
function OurVision() {
    ...
    const arr = [
        {
            id: 1,
            icon: (id) => <MdOutlineSettings size={80} color={selected === id ? 'white' : 'grey'} />,
        ...
        {
            id: 2,
            icon: (id) => <GoGoal size={80} color={selected === id ? 'white' : 'grey'} />,
            title: 'Our Mission',
        ...
        {
            id: 3,
            icon: (id) => <FaRegEye size={80} color={selected === id ? 'white' : 'grey'} />,
            title: 'Our Vision',
        ...
        {
            id: 4,
            icon: (id) => <LuBadgeCheck size={80} color={selected === id ? 'white' : 'grey'} />,
            title: 'Our Values',
