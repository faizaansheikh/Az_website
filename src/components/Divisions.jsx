        ...
        <div className='lg:mx-[200px] '>
            ...
            {arr.map((x, i) => (
                <div key={i} className='flex justify-center items-center ' >
                    {i % 2 === 0 ? (
                        <>
                            <div className="group relative w-full h-[330px] border-1 border-black rounded-l-[150px] cursor-pointer overflow-hidden bg-[black] shadow-2xl shadow-black">
                                {/* Background Image */}
                                <Image
                                    src={img}
                                    alt="Banner"
                        ...
                        <>
                            <div className='w-full h-[300px]'> </div>
                            <div className="group relative w-full h-[330px] border-1 border-black rounded-r-[150px] cursor-pointer overflow-hidden bg-[black] shadow-2xl shadow-black">
                                {/* Background Image */}
                                <Image
                                    src={img}
                                    alt="Banner"
